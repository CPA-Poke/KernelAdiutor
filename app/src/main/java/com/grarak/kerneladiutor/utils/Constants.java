...
public interface Constants {
    ...
    String HOTPLUG_MSM_SLEEPER = "/sys/kernel/msm_sleeper";
    String HOTPLUG_MSM_SLEEPER_ENABLE = HOTPLUG_MSM_SLEEPER + "/enabled";
    String HOTPLUG_MSM_SLEEPER_UP_THRESHOLD = HOTPLUG_MSM_SLEEPER + "/up_threshold";
    String HOTPLUG_MSM_SLEEPER_MAX_ONLINE = HOTPLUG_MSM_SLEEPER + "/max_online";
    String HOTPLUG_MSM_SLEEPER_DOWN_COUNT = HOTPLUG_MSM_SLEEPER + "/down_count";
    String HOTPLUG_MSM_SLEEPER_UP_COUNT = HOTPLUG_MSM_SLEEPER + "/up_count";
    String HOTPLUG_MSM_SLEEPER_DOWN_COUNT_MAX = HOTPLUG_MSM_SLEEPER + "/down_count_max";
    String HOTPLUG_MSM_SLEEPER_UP_COUNT_MAX = HOTPLUG_MSM_SLEEPER + "/up_count_max";

    String[] HOTPLUG_MSM_SLEEPER_ARRAY = {HOTPLUG_MSM_SLEEPER};
